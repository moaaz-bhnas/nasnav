...
import headerImageSm from '../image/dashboard-header-image-sm.png';
...
export default { headerImage, headerImageSm, serviceImage1, serviceImage2, serviceImage3, serviceImage4 };