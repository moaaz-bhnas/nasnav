  ...
  return (
    <article className="service styles" role="article">
      <div className="service__imageContainer  service__imageContainer_width_lessThanHalf service__imageContainer_float_left">
        <img src={styles} alt="your site is always at the top" className="image image_size_full serviceImageContainer__image styles__serviceImage serviceImage_stuck_left"/>
      </div>
